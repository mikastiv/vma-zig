...
pub const VulkanFunctions = extern struct {
    get_instance_proc_addr: vk.PfnGetInstanceProcAddr = null,
    get_device_proc_addr: vk.PfnGetDeviceProcAddr = null,
    get_physical_device_properties: vk.PfnGetPhysicalDeviceProperties = null,
    get_physical_device_memory_properties: vk.PfnGetPhysicalDeviceMemoryProperties = null,
    allocate_memory: vk.PfnAllocateMemory = null,
    free_memory: vk.PfnFreeMemory = null,
    map_memory: vk.PfnMapMemory = null,
    unmap_memory: vk.PfnUnmapMemory = null,
    flush_mapped_memory_ranges: vk.PfnFlushMappedMemoryRanges = null,
    invalidate_mapped_memory_ranges: vk.PfnInvalidateMappedMemoryRanges = null,
    bind_buffer_memory: vk.PfnBindBufferMemory = null,
    bind_image_memory: vk.PfnBindImageMemory = null,
    get_buffer_memory_requirements: vk.PfnGetBufferMemoryRequirements = null,
    get_image_memory_requirements: vk.PfnGetImageMemoryRequirements = null,
    create_buffer: vk.PfnCreateBuffer = null,
    destroy_buffer: vk.PfnDestroyBuffer = null,
    create_image: vk.PfnCreateImage = null,
    destroy_image: vk.PfnDestroyImage = null,
    cmd_copy_buffer: vk.PfnCmdCopyBuffer = null,
    get_buffer_memory_requirements2_khr: vk.PfnGetBufferMemoryRequirements2KHR = null,
    get_image_memory_requirements2_khr: vk.PfnGetImageMemoryRequirements2KHR = null,
    bind_buffer_memory2_khr: vk.PfnBindBufferMemory2KHR = null,
    bind_image_memory2_khr: vk.PfnBindImageMemory2KHR = null,
    get_physical_device_memory_properties2_khr: vk.PfnGetPhysicalDeviceMemoryProperties2KHR = null,
    get_device_buffer_memory_requirements: vk.PfnGetDeviceBufferMemoryRequirementsKHR = null,
    get_device_image_memory_requirements: vk.PfnGetDeviceImageMemoryRequirementsKHR = null,
    get_memory_win32_handle_khr: ?*anyopaque = null,
};
...
fn vkCheck(result: c.VkResult) Error!void {
    ...
    return switch (r) {
        ...
        .error_out_of_host_memory => error.error_out_of_host_memory,
        .error_out_of_device_memory => error.error_out_of_device_memory,
        .error_initialization_failed => error.error_initialization_failed,
        .error_device_lost => error.error_device_lost,
        .error_memory_map_failed => error.error_memory_map_failed,
        .error_layer_not_present => error.error_layer_not_present,
        .error_extension_not_present => error.error_extension_not_present,
        .error_feature_not_present => error.error_feature_not_present,
        .error_incompatible_driver => error.error_incompatible_driver,
        .error_too_many_objects => error.error_too_many_objects,
        .error_format_not_supported => error.error_format_not_supported,
        .error_fragmented_pool => error.error_fragmented_pool,
        .error_unknown => error.error_unknown,
        .error_validation_failed => error.error_validation_failed,
        .error_out_of_pool_memory => error.error_out_of_pool_memory,
        .error_invalid_external_handle => error.error_invalid_external_handle,
        .error_invalid_opaque_capture_address => error.error_invalid_opaque_capture_address,
        .error_fragmentation => error.error_fragmentation,
        .pipeline_compile_required => error.pipeline_compile_required,
        .error_not_permitted => error.error_not_permitted,
        .error_surface_lost_khr => error.error_surface_lost_khr,
        .error_native_window_in_use_khr => error.error_native_window_in_use_khr,
        .suboptimal_khr => error.suboptimal_khr,
        .error_out_of_date_khr => error.error_out_of_date_khr,
        .error_incompatible_display_khr => error.error_incompatible_display_khr,
        .error_invalid_shader_nv => error.error_invalid_shader_nv,
        .error_image_usage_not_supported_khr => error.error_image_usage_not_supported_khr,
        .error_video_picture_layout_not_supported_khr => error.error_video_picture_layout_not_supported_khr,
        .error_video_profile_operation_not_supported_khr => error.error_video_profile_operation_not_supported_khr,
        .error_video_profile_format_not_supported_khr => error.error_video_profile_format_not_supported_khr,
        .error_video_profile_codec_not_supported_khr => error.error_video_profile_codec_not_supported_khr,
        .error_video_std_version_not_supported_khr => error.error_video_std_version_not_supported_khr,
        .error_invalid_drm_format_modifier_plane_layout_ext => error.error_invalid_drm_format_modifier_plane_layout_ext,
        .error_present_timing_queue_full_ext => error.error_present_timing_queue_full_ext,
        .error_full_screen_exclusive_mode_lost_ext => error.error_full_screen_exclusive_mode_lost_ext,
        ...
        .error_invalid_video_std_parameters_khr => error.error_invalid_video_std_parameters_khr,
        .error_compression_exhausted_ext => error.error_compression_exhausted_ext,
        ...
        .error_not_enough_space_khr => error.error_not_enough_space_khr,
        else => error.Unknown,
    };
}
